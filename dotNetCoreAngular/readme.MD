...
app.UseWebpackDevMiddleware(...) : Webpack HotModuleReplacement auto refresh client side page without restart the project
...
* setup machine level developement environment for mac
